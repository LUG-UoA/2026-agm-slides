...
#let paper-light = (
  accent-primary: rgb("#3fcca8"),
  accent-secondary: rgb("#6290C3"),
  accent-subtle: rgb("#F5F5F5"),
  accent-glow: rgb("#3fcca8"),
  accent-deep: rgb("#1A1B41"),
  bg-base: rgb("#FFFFFF"),
  bg-elevated: rgb("#FFFFFF"),
  bg-muted: rgb("#F8F8F8"),
  ...
  example-border: rgb("#3fcca8"),
  example-text: rgb("#3fcca8"),
  focus-bg: rgb("#3fcca8"),
  focus-text: rgb("#FFFFFF"),
  // Standout slide
  ...
  header-bg: rgb("#3fcca8"),
  header-text: rgb("#000000"),
)
