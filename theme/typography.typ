...
#let font-heading = ("Lato", "Source Sans 3", "Inter", "Noto Sans", "sans-serif")
#let font-body = ("Lato", "Source Sans 3", "Inter", "Noto Sans", "sans-serif")
#let font-mono = ("Fira Mono", "Fira Code", "Noto Sans Mono", "monospace")
